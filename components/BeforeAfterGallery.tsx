...
const pairs: BeforeAfterPair[] = [
    ...
    { id: '5', label: 'Procedimento 05', before: '/images/photos/IMAGEM_05.webp', after: '/images/photos/IMAGEM_05_1.webp' },
    { id: '6', label: 'Procedimento 06', before: '/images/photos/IMAGEM_06.webp', after: '/images/photos/IMAGEM_06_1.webp' },
    { id: '7', label: 'Procedimento 07', before: '/images/photos/IMAGEM_07.webp', after: '/images/photos/IMAGEM_07_1.webp' },
    { id: '8', label: 'Procedimento 08', before: '/images/photos/IMAGEM_08.webp', after: '/images/photos/IMAGEM_08_1.webp' },
    { id: '9', label: 'Procedimento 09', before: '/images/photos/IMAGEM_09.webp', after: '/images/photos/IMAGEM_09_1.webp', landscape: true },
    { id: '10', label: 'Procedimento 10', before: '/images/photos/IMAGEM_10.webp', after: '/images/photos/IMAGEM_10_1.webp' },
    { id: '11', label: 'Procedimento 11', before: '/images/photos/IMAGEM_11.webp', after: '/images/photos/IMAGEM_11_1.webp' },
    { id: '12', label: 'Procedimento 12', before: '/images/photos/IMAGEM_12.webp', after: '/images/photos/IMAGEM_12_1.webp' },
];
        ...
        <div className="mt-20">
            <FadeIn direction="none">
                <div className="text-center mb-12">
                    ...
                    <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-[#2C2C2C]">
                        Antes &amp; Depois
                    </h3>
