...
const services = [
    ...
    },
    {
        ...
        highlights: ['Efeito lifting sem cirurgia', 'Olhar mais aberto e expressivo', 'Resultados sutis e elegantes'],
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/photo-1585747860019-8bc1e35ecb9d?w=700&q=80',
    },
    {
        id: 'botox',
        title: 'Botox',
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    <FadeIn delay={600}>
                        <p className="text-white/60 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                            Conheça todos os procedimentos realizados pela Dra. Melissa Tamayo, com técnica refinada e foco em resultados naturais.
                        </p>
                    </FadeIn>
                </div>
            </section>
                            ...
                            <div className={`flex flex-col justify-center ${idx % 2 !== 0 ? 'md:order-1' : ''}`}>
                                <FadeIn direction={idx % 2 !== 0 ? 'left' : 'right'} delay={150}>
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.14em] text-[#2C2C2C] hover:text-[#C9A84C] transition-colors group"
                                    >
                                        Agendar Consulta
                                        <svg
