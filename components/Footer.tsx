        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <FadeIn direction="left">
            <div className="space-y-6">
              <div className="flex items-center">
                <img loading="lazy" decoding="async" src="/images/icons/logo dourada.webp" alt="Dra. Melissa Tamayo" className="h-24 w-auto object-contain" />
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={100}>
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium">
                ...
                <li><a href="#contato" className="hover:text-[#C9A84C] transition-colors">Contato</a></li>
              </ul>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={200}>
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium">
                <li><a href="https://www.instagram.com/dramelissatamayo/" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9A84C] transition-colors">Instagram</a></li>
                <li><a href="https://wa.me/5592984685391" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9A84C] transition-colors">WhatsApp</a></li>
                <li><a href="https://www.facebook.com/melissa.tamayo.54" target="_blank" rel="noopener noreferrer" className="hover:text-[#C9A84C] transition-colors">Facebook</a></li>
              </ul>
            </div>
          </FadeIn>
