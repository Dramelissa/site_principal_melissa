...
const Hero: React.FC<HeroProps> = ({ onOpenContact }) => {
  return (
    <section className="relative h-screen min-h-[700px] w-full flex items-end pb-40 md:items-center md:pb-0 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-[1480px] mx-auto px-4 sm:px-8 mt-20 md:mt-0">
          ...
          <FadeIn delay={600}>
            <div className="flex flex-col gap-4 w-full sm:w-max">
              <button
                ...
                className="group w-full bg-[#C9A84C] text-white px-4 py-3 md:px-8 md:py-3 rounded-full font-medium text-base md:text-lg hover:bg-[#A07832] transition-all flex items-center justify-center gap-0 hover:gap-2 whitespace-nowrap"
              >
              ...
              <button
                onClick={onOpenContact}
                className="group w-full bg-transparent border border-white text-white px-4 py-3 md:px-8 md:py-3 rounded-full font-medium text-base md:text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2 whitespace-nowrap"
              >
                {/* Ícone WhatsApp */}
