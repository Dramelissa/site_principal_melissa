                ...
                <form onSubmit={handleSubmit} className="px-8 pb-8 pt-4 space-y-5">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full bg-white border border-[#E0CC89]/30 rounded-lg px-4 py-3 text-sm text-[#2C2C2C] focus:outline-none focus:border-[#C9A84C] focus:ring-1 focus:ring-[#C9A84C]/30 transition-colors appearance-none"
                            style={{
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full bg-white border border-[#E0CC89]/30 rounded-lg px-4 py-3 text-sm text-[#2C2C2C] placeholder:text-[#6B6B6B]/40 focus:outline-none focus:border-[#C9A84C] focus:ring-1 focus:ring-[#C9A84C]/30 transition-colors resize-none"
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        className="w-full bg-[#C9A84C] text-white py-3.5 rounded-full font-medium text-base hover:bg-[#A07832] transition-colors flex items-center justify-center gap-2"
                    >
