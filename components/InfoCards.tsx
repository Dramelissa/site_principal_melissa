  ...
  <FadeIn delay={index * 150} direction="up">
    <a href={href} className="group cursor-pointer flex flex-col bg-white rounded-[2rem] overflow-hidden shadow-lg h-full block">
      ...
      <div className="flex-1 min-h-[250px] md:min-h-[200px] lg:min-h-[280px]">
        <img src={image} alt={title} className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" style={{ filter: 'contrast(1.08) saturate(1.1) brightness(1.02)', transform: 'translateZ(0)', backfaceVisibility: 'hidden' }} />
      </div>
    </a>
  </FadeIn>
);
  ...
  const cards = [
    {
      ...
      image: "/images/procedimentos/Blefaroplastia.webp",
    ...
    },
    {
      ...
      image: "/images/procedimentos/Lifting Temporal  Fox Eyes.webp",
